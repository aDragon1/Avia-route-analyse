...
import self.adragon.aviarouteanalyse.ui.dialogs.SearchParamsDialog
import self.adragon.aviarouteanalyse.ui.viewmodels.FlightViewModel

class ListData : Fragment(R.layout.list_data) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = FlightRecyclerViewAdapter(R.layout.list_data_item, false)
        ...
        val paramsDialog = SearchParamsDialog()
